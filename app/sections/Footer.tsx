...
const Footer = () => {
  ...
  <div className="w-full flex flex-col  justify-center items-center mx-10">
    ...
    <div className="w-full md:px-10 flex flex-col md:flex-row items-start justify-between md:items-center gap-y-12 ">
      ...
      <div className="flex-col gap-y-3">
        ...
        <div className="">
          <h2 className="text-white text-2xl md:text-4xl pr-20 md:pr-40">Helping Dental Practices Grow and Succeed in the Digital Era</h2>
        </div>
      </div>
...
<div className="flex flex-col gap-y-2">
    ...
    <div className="w-full flex flex-col items-start justify-center md:items-center mt-10 ">
      <hr className="text-white md:w-[600px] pb-5"></hr>
      <h4 className="text-white text-center pr-10">Copyright @ 2025 Dtout Agency. All Rights Reserved</h4>
    </div>
